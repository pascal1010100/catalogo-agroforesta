...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className="flex items-center justify-between px-6 py-4 bg-white/90 dark:bg-green-900/90 shadow sticky top-0 z-50"
        role="navigation"
      ...
      >
        <Link href="/" className="block font-medium text-green-700 dark:text-green-200 hover:text-green-900 dark:hover:text-green-400" onClick={handleLinkClick} role="menuitem">
          Inicio
        </Link>
        <Link href="/productos" className="block font-medium text-green-700 dark:text-green-200 hover:text-green-900 dark:hover:text-green-400" onClick={handleLinkClick} role="menuitem">
          Productos
        </Link>
        <a
          href="#contacto"
